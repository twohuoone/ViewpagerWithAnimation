...
public class PhoneUtil_a {
    private static PhoneUtil_a phoneUtil;

    public static PhoneUtil_a getInstance() {
        if (phoneUtil == null) {
            synchronized (PhoneUtil_a.class) {
                if (phoneUtil == null) {
                    phoneUtil = new PhoneUtil_a();
                }
            }
        }
        return phoneUtil;
